...
import static net.archiscape.app.core.test.util.OAuth2TestUtil.ID_TOKEN;
import static net.archiscape.app.core.test.util.OAuth2TestUtil.authenticationToken;
