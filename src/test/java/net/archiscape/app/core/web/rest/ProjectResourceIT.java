...
class ProjectResourceIT {
    ...
    void createProject() throws Exception {
        ...
        assertThat(testProject.getConfiguration()).isEqualTo(DEFAULT_CONFIGURATION);
    ...
    void putNewProject() throws Exception {
        ...
        assertThat(testProject.getConfiguration()).isEqualTo(UPDATED_CONFIGURATION);
    ...
    void partialUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.name(UPDATED_NAME).active(UPDATED_ACTIVE).contentStoreUrl(UPDATED_CONTENT_STORE_URL);
