...
class ProjectViewResourceIT {
    ...
    public static ProjectView createEntity(EntityManager em) {
        ProjectView projectView = new ProjectView().name(DEFAULT_NAME).documentation(DEFAULT_DOCUMENTATION).c4level(DEFAULT_C_4_LEVEL);
        // Add required entity
        Project project;
    ...
    public static ProjectView createUpdatedEntity(EntityManager em) {
        ProjectView projectView = new ProjectView().name(UPDATED_NAME).documentation(UPDATED_DOCUMENTATION).c4level(UPDATED_C_4_LEVEL);
        // Add required entity
        Project project;
        if (TestUtil.findAll(em, Project.class).isEmpty()) {
    ...
    void putNewProjectView() throws Exception {
        ...
        updatedProjectView.name(UPDATED_NAME).documentation(UPDATED_DOCUMENTATION).c4level(UPDATED_C_4_LEVEL);
    ...
    void partialUpdateProjectViewWithPatch() throws Exception {
        ...
        partialUpdatedProjectView.name(UPDATED_NAME).documentation(UPDATED_DOCUMENTATION);
    ...
    void fullUpdateProjectViewWithPatch() throws Exception {
        ...
        partialUpdatedProjectView.name(UPDATED_NAME).documentation(UPDATED_DOCUMENTATION).c4level(UPDATED_C_4_LEVEL);
