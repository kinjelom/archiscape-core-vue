...
/**
 * REST controller for managing {@link net.archiscape.app.core.domain.Team}.
 */
@RestController
@RequestMapping("/api")
public class TeamResource {
     ...
     */
    @PutMapping("/teams/{id}")
    public ResponseEntity<Team> updateTeam(@PathVariable(value = "id", required = false) final String id, @Valid @RequestBody Team team)
    ...
    public ResponseEntity<Team> partialUpdateTeam(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, team.getId()));
    }
