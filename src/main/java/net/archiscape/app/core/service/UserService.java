...
import net.archiscape.app.core.config.Constants;
import net.archiscape.app.core.domain.Authority;
import net.archiscape.app.core.domain.User;
import net.archiscape.app.core.repository.AuthorityRepository;
import net.archiscape.app.core.repository.UserRepository;
import net.archiscape.app.core.security.SecurityUtils;
import net.archiscape.app.core.service.dto.AdminUserDTO;
import net.archiscape.app.core.service.dto.UserDTO;
