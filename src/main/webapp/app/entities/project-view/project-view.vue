      ...
      <table class="table table-striped" aria-describedby="projectViews">
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('imageName')">
              <span v-text="$t('archiscapeCoreApp.projectView.imageName')">Image Name</span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'imageName'"></jhi-sort-indicator>
            </th>
            <th scope="row" v-on:click="changeOrder('imageData')">
              <span v-text="$t('archiscapeCoreApp.projectView.imageData')">Image Data</span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'imageData'"></jhi-sort-indicator>
            </th>
        ...
        <tbody>
          <tr v-for="projectView in projectViews" :key="projectView.id" data-cy="entityTable">
            ...
            <td>{{ projectView.imageName }}</td>
            <td>
              <a v-if="projectView.imageData" v-on:click="openFile(projectView.imageDataContentType, projectView.imageData)">
                <img
              ...
              <span v-if="projectView.imageData">{{ projectView.imageDataContentType }}, {{ byteSize(projectView.imageData) }}</span>
            </td>
            <td>
