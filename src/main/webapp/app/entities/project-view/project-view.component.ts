...
export default class ProjectView extends Vue {
  ...
  public retrieveAllProjectViews(): void {
  ...
  public prepareRemove(instance: IProjectView): void {
  ...
  public removeProjectView(): void {
    this.projectViewService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('archiscapeCoreApp.projectView.deleted', { param: this.removeId });
