    ...
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('archiscapeCoreApp.project.configuration')" for="project-configuration"
              >Configuration</label
            >
            <input
              type="text"
              ...
              :class="{ valid: !$v.project.configuration.$invalid, invalid: $v.project.configuration.$invalid }"
              v-model="$v.project.configuration.$model"
            />
            <div v-if="$v.project.configuration.$anyDirty && $v.project.configuration.$invalid">
              <small
                class="form-text text-danger"
                v-if="!$v.project.configuration.maxLength"
